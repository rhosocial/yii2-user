...
use rhosocial\user\rbac\permissions\ListUser;
...
class M170310150337CreateAuthTables extends Migration
{
    ...
    protected function addRoles()
    {
        ...
        $authManager->addChild($admin, $listUser);
